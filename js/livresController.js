...
var livresController = (function () {
    function livresController($scope) {
        this.livres = [];
        $scope.VM = this;
        this.livres = [
    ...
    livresController.prototype.delete = function (index) {
        this.livres.splice(index, 1);
    };
    livresController.prototype.update = function (livre) {
        this.isEditing = true;
        this.newLivre = livre;
    };
    livresController.prototype.add = function () {
        this.livres.push(this.newLivre);
        this.newLivre = null;
    };
    livresController.prototype.stopModify = function () {
