...
var dvdsController = (function () {
    function dvdsController($scope) {
        this.dvds = [];
        $scope.VM = this;
        this.dvds = [
    ...
    dvdsController.prototype.delete = function (index) {
        this.dvds.splice(index, 1);
    };
    dvdsController.prototype.update = function (dvd) {
        this.isEditing = true;
        this.newDvd = dvd;
    };
    dvdsController.prototype.add = function () {
        this.dvds.push(this.newDvd);
        this.newDvd = null;
    };
    dvdsController.prototype.stopModify = function () {
        this.isEditing = false;
        this.newDvd = null;
    };
    return dvdsController;
})();
